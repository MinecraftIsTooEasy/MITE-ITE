...
//    }
    ...
    public static void registerForgingRecipe(Material material, ForgingTableLevel level, int maxLevel) {
        if (maxLevel >= 0) {
            ForgingRecipe.Builder.of(material, 0, level).setChanceOfFailure(Items.IRON_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(2048).setHammerDurabilityCost(2048).setTimeReq(400).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).addMaterials(new ItemStack(Items.ingotGold, 1), new ItemStack(Items.ingotIron, 1), new ItemStack(Items.IRON_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 1) {
            ForgingRecipe.Builder.of(material, 1, level).setChanceOfFailure(Items.IRON_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(2048).setHammerDurabilityCost(3072).setTimeReq(600).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).setQualityReward(EnumQuality.fine).addMaterials(new ItemStack(Items.ingotGold, 1), new ItemStack(Items.ingotIron, 2), new ItemStack(Items.IRON_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 2) {
            ForgingRecipe.Builder.of(material, 2, level).setChanceOfFailure(Items.IRON_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(3072).setHammerDurabilityCost(3072).setTimeReq(800).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).setQualityReward(EnumQuality.fine).addMaterials(new ItemStack(Items.ingotGold, 2), new ItemStack(Items.ingotIron, 2), new ItemStack(Items.IRON_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 3) {
            ForgingRecipe.Builder.of(material, 3, level).setChanceOfFailure(Items.IRON_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(3072).setHammerDurabilityCost(4096).setTimeReq(1000).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).setQualityReward(EnumQuality.excellent).addMaterials(new ItemStack(Items.ingotGold, 2), new ItemStack(Items.ingotIron, 2), new ItemStack(Items.IRON_ENHANCE_STONE, 2)).build(registerer);
        }
        if (maxLevel >= 4) {
            ForgingRecipe.Builder.of(material, 4, level).setChanceOfFailure(Items.MITHRIL_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(4096).setHammerDurabilityCost(4096).setTimeReq(1200).setQualityReward(EnumQuality.excellent).addFaultFeedback(DowngradeFeedback.of(1)).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).addMaterials(new ItemStack(Items.ingotGold, 1), new ItemStack(Items.ingotMithril, 1), new ItemStack(Items.redstone, 1), new ItemStack(Items.MITHRIL_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 5) {
            ForgingRecipe.Builder.of(material, 5, level).setChanceOfFailure(Items.MITHRIL_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(4096).setHammerDurabilityCost(6144).setTimeReq(1400).setQualityReward(EnumQuality.superb).addFaultFeedback(DowngradeFeedback.of(1)).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).addMaterials(new ItemStack(Items.ingotGold, 2), new ItemStack(Items.ingotMithril, 1), new ItemStack(Items.redstone, 2), new ItemStack(Items.MITHRIL_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 6) {
            ForgingRecipe.Builder.of(material, 6, level).setChanceOfFailure(Items.MITHRIL_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(6144).setHammerDurabilityCost(6144).setTimeReq(1600).setQualityReward(EnumQuality.superb).addFaultFeedback(DowngradeFeedback.of(1)).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(5))).addMaterials(new ItemStack(Items.ingotGold, 2), new ItemStack(Items.ingotMithril, 2), new ItemStack(Block.blockRedstone, 1), new ItemStack(Items.MITHRIL_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 7) {
            ForgingRecipe.Builder.of(Materials.vibranium, 7, ForgingTableLevel.VIBRANIUM).setChanceOfFailure(Items.ADAMANTIUM_ENHANCE_STONE.getFailChance()).setAxeDurabilityCost(6144).setHammerDurabilityCost(8192).setTimeReq(1800).setQualityReward(EnumQuality.masterwork).addFaultFeedback(DowngradeFeedback.of(1)).addFaultFeedback(DurabilityFeedback.of(DurabilityFeedback.Type.ofPercentage(10))).addMaterials(new ItemStack(Items.ghastTear, 1), new ItemStack(Items.ingotAdamantium, 1), new ItemStack(Item.ingotMithril, 2), new ItemStack(Items.ADAMANTIUM_ENHANCE_STONE, 1)).build(registerer);
        }
        if (maxLevel >= 8) {
